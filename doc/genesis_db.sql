...
FOREIGN KEY (belongs_to_project) REFERENCES Project(id),
...
access_control_qualifier varchar(255) NOT NULL,
revision int NOT NULL,
PRIMARY KEY (subclass, superclass, revision),
...
revision int NOT NULL,
PRIMARY KEY (id, candidate, revision),
...
revision int NOT NULL,
PRIMARY KEY (invoked_by, candidates, revision),
...
FOREIGN KEY (previous_assignee) REFERENCES Developers(id)
);
...
revision int NOT NULL,
PRIMARY KEY (method_id, name, value, revision),
...
value varchar(255) NOT NULL,
revision int NOT NULL,
PRIMARY KEY (class_id, name, value, revision),
